      ...
      try {
        ...
        if (Array.isArray(r)) {
          ...
          const filteredRepos = r
            .filter((repo: Repo) => allowedRepos.includes(repo.name))
            .sort(
              (a: Repo, b: Repo) => allowedRepos.indexOf(a.name) - allowedRepos.indexOf(b.name),
            );
          ...
          {user ? (
            <>
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                Full Stack MERN Developer | React • Node.js • Express.js | MongoDB | Building
                Scalable Web Applications & Modern Digital Solutions
              </p>
